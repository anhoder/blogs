...
一直想了解一下PHP底层源码的实现，同时还可以增强自己的C语言能力，于是颇有兴致的在PHP官网下载了源码，打开整个项目却不知从何下手，然后就找了阅读资料---[《TIPI：深入了解PHP内核》](https://www.php-internals.com)，感谢各位编写的大佬！   

因此，该系列博客都是在阅读《TIPI：深入了解PHP内核》后自己的一些总结、摘录。
## 一、PHP源码目录结构
