...
主要实现思路是使用pulseaudio进行音频转发，[wsl-audio-musicbox](https://github.com/anhoder/wsl-audio-musicbox)项目主要是为了简化WSL与Windows之间通信转发的配置。
...
![musicbox](media/15981627088961/musicbox.png)
